...
class Data_loader():
    def __init__(self, args, train_set, phase="train"):
        ...
        if phase == "train":
            ...
            #Load the training batch dataset
    ...
    def dataPreprocess(self,setname):
        ...
        if setname=='train':
            ...
            #Extract the index of the validation set
            val_index=data_index[1][:,:int(data_index[1].shape[1]*val_fraction)]
            #Extract the index of the test set
            ...
            #Obtain the data of the training batch and the verification batch
            ...
            #Calculate the number of training batches and verification batches
    ...
    def get_seq_from_index_balance(self,frameped_dict,pedtraject_dict,data_index,setname,setNum):
        ...
        for i in range(data_index.shape[1]):
            ...
            try:
                ...
                continue
            #The set of pedestrian ids in 20 time steps
            ...
            for ped in present_pedi:
                #The data of the pedestrian with the id of ped at 20 time steps
    ...
    def massup_batch(self,batch_data):
        ...
        '''
        num_Peds=0
        #batch_data: The number of current trajectory sequences
    ...
    #setNum:Represent the label of the data set
