...
def get_parser():
    parser = argparse.ArgumentParser(description='PMITra')
    ...
    parser.add_argument('--train_model', default='PMITra',help='Your model name')
    parser.add_argument('--load_model', default=-1,type=int,help="load model weights from this index before training or testing")
    parser.add_argument('--model', default='models.PMITra')
    ######################################
    # -----necessary to provide ----begin
    parser.add_argument('--dataset',default='ethucy')
    # ethucy-domains = ['eth', 'hotel', 'zara01', 'zara02', 'students001', 'students003', 'uni_examples', 'zara03']
    parser.add_argument('--source_domain', default='eth')
    parser.add_argument('--target_domain', default='hotel')
    ...
    parser.add_argument('--ballance_param', default=0.4, type=float,help="loss ballance param")
    return parser
